...
tmux send-keys -t monitor.1 'watch -n 3 "pstree -U |grep -E \"(mysql|vim|ruby|rails|pa_|my_|redis|sidekiq|delayed_job|ssh)\" | grep -v grep"' C-m
tmux send-keys -t monitor.2 '' C-m
