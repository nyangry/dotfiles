...
let g:colors_name = "grb256_b"

hi pythonSpaceError ctermbg=red guibg=red

hi Comment ctermfg=darkgray

hi StatusLine guifg=#FFFFFF ctermbg=darkgrey ctermfg=white
hi StatusLineNC ctermbg=black ctermfg=lightgrey
hi VertSplit ctermbg=black ctermfg=lightgrey
hi LineNr ctermfg=darkgray
hi CursorLine     guifg=NONE        guibg=#333333      ctermfg=NONE        ctermbg=234
hi Function         guifg=#FFFFCC     guibg=NONE        gui=NONE      ctermfg=yellow       ctermbg=NONE        cterm=NONE
...
hi Operator        guifg=#CCCCFF     guibg=NONE        gui=NONE      ctermfg=lightblue   ctermbg=NONE        cterm=NONE
